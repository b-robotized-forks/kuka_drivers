...
#ifndef KUKA_CARTESIAN_SETPOINT_BROADCASTER__KUKA_CARTESIAN_SETPOINT_BROADCASTER_HPP_
#define KUKA_CARTESIAN_SETPOINT_BROADCASTER__KUKA_CARTESIAN_SETPOINT_BROADCASTER_HPP_
...
{
class CartesianSetpointBroadcaster : public controller_interface::ControllerInterface
{
public:
...
private:
  ...
  // Must match the "cartesian_setpoint" sensor component name declared in kuka.ros2_control.xacro
  // (state interfaces x, y, z, a, b, c) when read_cartesian_setpoint is enabled.
  static constexpr char kSensorName[] = "cartesian_setpoint";
};
}  // namespace kuka_controllers
#endif  // KUKA_CARTESIAN_SETPOINT_BROADCASTER__KUKA_CARTESIAN_SETPOINT_BROADCASTER_HPP_

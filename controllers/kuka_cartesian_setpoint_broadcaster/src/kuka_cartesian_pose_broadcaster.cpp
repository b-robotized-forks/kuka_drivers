...
#include "kuka_cartesian_setpoint_broadcaster/kuka_cartesian_pose_broadcaster.hpp"
...
controller_interface::CallbackReturn CartesianPoseBroadcaster::on_init()
{
  pose_publisher_ = get_node()->create_publisher<geometry_msgs::msg::Pose>(
    "~/cartesian_pose", rclcpp::SystemDefaultsQoS());
  return controller_interface::CallbackReturn::SUCCESS;
}

controller_interface::InterfaceConfiguration
CartesianPoseBroadcaster::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration
CartesianPoseBroadcaster::state_interface_configuration() const
{
...
controller_interface::CallbackReturn CartesianPoseBroadcaster::on_configure(
  const rclcpp_lifecycle::State &)
{
  return controller_interface::CallbackReturn::SUCCESS;
}

controller_interface::CallbackReturn CartesianPoseBroadcaster::on_activate(
  const rclcpp_lifecycle::State &)
{
  return controller_interface::CallbackReturn::SUCCESS;
}

controller_interface::CallbackReturn CartesianPoseBroadcaster::on_deactivate(
  const rclcpp_lifecycle::State &)
{
  return controller_interface::CallbackReturn::SUCCESS;
}
...
PLUGINLIB_EXPORT_CLASS(
  kuka_controllers::CartesianPoseBroadcaster, controller_interface::ControllerInterface)

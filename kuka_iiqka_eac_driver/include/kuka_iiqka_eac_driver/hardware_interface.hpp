...
public:
  ...
  // on_export_command_interfaces() already builds and registers them - only the two interfaces
  // that AREN'T declared per-joint (server_state, control_mode) need declaring here.
